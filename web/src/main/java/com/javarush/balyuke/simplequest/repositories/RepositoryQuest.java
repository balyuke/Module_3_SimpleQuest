...
//                storyAcquaintanceText);
        ...
        Question q1 = new Question(101, "Ты потерял память. Принять вызов НЛО?", quest1, Question.Type.CONTINUE);
        Question q2 = new Question(102, "Ты принял вызов. Поднимешься на мостик к их капитану?", quest1, Question.Type.CONTINUE);
        Question q3 = new Question(103, "Ты отклонил вызов. Смерть.", quest1, Question.Type.LOST);
        Question q4 = new Question(104, "Ты поднялся на мостик. Ты кто?", quest1, Question.Type.CONTINUE);
        Question q5 = new Question(105, "Ты не пошел на переговоры. Смерть.", quest1, Question.Type.LOST);
        Question q6 = new Question(106, "Тебя отвезли домой. Победа.", quest1, Question.Type.WON);
        Question q7 = new Question(107, "Твою ложь разоблачили. Смерть.", quest1, Question.Type.LOST);

        Answer a1 = new Answer(101, "Принять вызов.", quest1, q1, q2);
        Answer a2 = new Answer(102, "Отклонить вызов.", quest1, q1, q3);
        Answer a3 = new Answer(103, "Подняться на мостик.", quest1, q2, q4);
        Answer a4 = new Answer(104, "Отказаться подниматься на мостик.", quest1, q2, q5);
        Answer a5 = new Answer(105, "Рассказать правду о себе.", quest1, q4, q6);
        Answer a6 = new Answer(106, "Солгать о себе.", quest1, q4, q7);
